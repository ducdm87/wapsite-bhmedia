    ...
    'components' => array(
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                'minh-bach-xang-dau/' => array('articles/category',".html",'defaultParams'=>array("alias"=>"minh-bach-xang-dau")),
                'cay-xang-gian-lan/' => array('articles/category',".html",'defaultParams'=>array("alias"=>"cay-xang-gian-lan")),
                'minh-bach-xang-dau/trang-<page:[0-9]+>' => array('articles/category',".html",'defaultParams'=>array("alias"=>"minh-bach-xang-dau")),
                'cay-xang-gian-lan/trang-<page:[0-9]+>' => array('articles/category',".html",'defaultParams'=>array("alias"=>"cay-xang-gian-lan")),
                'minh-bach-xang-dau/<cid:[0-9]+>-<alias:.*>' => array('articles/detail','urlSuffix'=>'.html','defaultParams'=>array("cat_alias"=>"minh-bach-xang-dau")),
                'cay-xang-gian-lan/<cid:[0-9]+>-<alias:.*>' => array('articles/detail','urlSuffix'=>'.html','defaultParams'=>array("cat_alias"=>"cay-xang-gian-lan")),
